...
import Stars from '../../../public/assets/images/stars.webp';
import Clouds from '../../../public/assets/images/clouds.webp';
import Lightning from '../../../public/assets/images/lightning.webp';
    ...
    return (
        <header className="relative h-[18vh] bg-slate-100 dark:bg-slate-800">
            <div
                ...
                style={{
                    backgroundImage: selectedTheme === 'light' ? `url(${Sun})` : `url(${Stars})`
                }}
            ></div>
            <div
                ...
                style={{
                    backgroundImage: selectedTheme === 'light' ? `url(${Clouds})` : `url(${Lightning})`
                }}
            ></div>
